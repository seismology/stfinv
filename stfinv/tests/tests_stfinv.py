...
# -------------------------------------------------------------------
#   Filename:  tests_stfinv.py
#   Purpose:   Test routines for main file
...
def test_correct_waveforms_unsorted():
    ...
    # Change the order of traces in st_data
    st_data.sort(keys=['station'], reverse=True)
